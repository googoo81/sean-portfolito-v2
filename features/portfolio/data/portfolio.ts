...
export const portfolio: Portfolio = {
  intro: {
    ...
    headlineLines: ["기획한 아이디어를", "직접 구현하는 마케터"],
    lines: [
  ...
  projects: [
    {
      slug: "team-sparta",
      number: "03",
      shortName: "TEAM SPARTA",
      tagline: "One brand. Three motivations.",
      disciplines: ["Campaign", "Segmentation", "Strategy"],
      theme: "sparta",
    ...
    },
    {
      slug: "meta-comedy",
      number: "02",
      shortName: "META COMEDY CLUB",
      tagline: "From scroll to ticket.",
      disciplines: ["Brand Content", "Carousel", "Copy"],
      theme: "meta",
    ...
    },
    {
      ...
      number: "01",
      shortName: "VARIWAY",
      tagline: "Protein shake, styled like fashion.",
      disciplines: ["Content Strategy", "Social", "Reels"],
      theme: "variway",
