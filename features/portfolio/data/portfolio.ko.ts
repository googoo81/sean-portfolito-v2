  ...
  projects: [
    {
      ...
      creative: {
        label: "Reel Creative",
        lead: "브랜드 무드를 분석해 콘셉트로 옮기고, 실제 릴스까지 제작했습니다.",
      ...
      closing: {
        ...
        body: "시장 분석 → 전략 → 채널 → 콘텐츠 → 미디어믹스를 하나의 흐름으로 설계했습니다. 이 프로젝트에서 보여주고 싶은 것은 단일 성과 수치가 아니라, 재구매 접점을 구조화할 수 있는 전략 기획 역량입니다.",
      },
      cover: {
      ...
      closing: {
        ...
        after: {
          ...
          metrics: [
            {
              label: "스크롤률",
              value: "78.2% → 85.7% (+7.5%p)",
            },
            {
              label: "테스트 시작 → CTA",
              value: "23.9% → 66.0% (+42.1%p)",
            },
            {
              label: "최종 CTA 클릭",
              value: "26명(4.7%) → 31명(6.2%)",
            },
          ],
          insight:
            "유입 절대 수는 줄었지만 전환 효율이 올랐고, 테스트에 들어온 사용자가 거의 끝까지 완주하는 구조로 개선되었습니다.",
        },
